...
const buttonStyle = tv({
  base: "rounded-sm flex items-center justify-center text-sm font-medium disabled:cursor-not-allowed disabled:opacity-50",
  defaultVariants: {
    intent: "default",
    size: "sm",
  },
  variants: {
    intent: {
      default:
        "bg-primary text-white hover:bg-hoverPrimary disabled:bg-disabled",
      outline:
      ...
      secondary: "bg-secondary text-white hover:bg-secondary/30",
      error: "bg-black text-white hover:bg-black/30",
